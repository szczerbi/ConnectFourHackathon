...
namespace Player
{
  public abstract class IArtificialPlayer : IPlayer
  {
    /// <summary>
    /// Returns the column index of the player's next move, given the current board state.
    /// </summary>
    /// <param name="currentBoard">
    ///   2d array representing the board. 0,0 is the top left corner of the board.
    ...
    /// </returns>
    public abstract int GetNextMove(state[][] currentBoard);
